            ...
            <div className="absolute w-2/3 right-0 top-0 h-full flex justify-center place-items-start py-24">
                <div className="flex flex-col w-3/5 place-items-center">
                    ...
                    <div>
                        ...
                        <Paragraph content={`You see, by creating initiatives to accordingly support this growing population, he would be taking valuable experience away from us--valuable experience that could be used to hone our survival skills. Newcomers may wonder, “Will there be enough housing to fit us comfortably?” Pfft. We don’t need that. This “housing crisis” is just a hoax made up by right-wing conservatives to protect the rich people’s mansions. We have ample housing. Why build more houses and destroy the environment, when 20 people can comfortably live in one house, like we’ve seen in Brampton? They’ve done it easily, and so can the rest of Canada. Trudeau’s been so valuable to Canadians by showing us how greedy we've become with space, and offering a way to show that we can become better human beings by coexisting more efficiently, thereby enhancing our ability to survive.`} />
                        <Paragraph content={`Also, he, completely intentionally, indirectly increased prices of foods! While this may seem bad, think about it like this: all those “healthy” organic foods that you feed your children? Nope! Too expensive! Instead, we now have the opportunity to feed our children McDonald’s and 2-litre bottles of Coke, and that’ll make them big and strong by conditioning their immune systems! And in the event that even those beloved foods become too expensive, we can always, always rely on food banks.`} />
                        <Paragraph content={`And speaking of health, Trudeau displays the high regard to which he holds healthcare professionals, as he does with his perfect, universally beneficial plans. You might raise an eyebrow when you hear, “We’re increasing the number of people that healthcare professionals have to deal with, but not the actual number of healthcare professionals.” But don’t you understand the underlying ingenuity? He loves them so much that he’s willing to let them shine and show their true capabilities! He’s trying to say to everyone in the world, “Look at our healthcare! It’s perfect the way it is!” And it’s true. In other countries, the naive healthcare systems would admit people in critical condition right away. Now, though, when in a life-or-death situation and needing emergency care, you can give them a few hours to prepare so they can save you! (Please bear in mind that you will have to survive on your own during that time)`} />
                        <Paragraph content={`Some people (pessimists, really) have some concerns about Trudeau’s plan. Can you imagine? Some say, won’t this ambitious immigration target potentially lead to too much competition in the already-strained job market? While this question seems logical, Trudeau delivers such a well thought-out, eloquent response. And it makes sense once you think about it! Here it is: You see, this increase in competition for jobs is actually perfect for Canada! It’ll encourage students to do better in school and discover their passions more quickly. And… well… if they can’t find a job… then it’s just natural selection, right? Yeah. It’s never Trudeau’s fault, only ours. Because Trudeau is never, ever wrong.`} />
                        <Paragraph content={`So, I think I can speak for all of us when I say that Trudeau has shown us how to become real survivalists. Through his masterful planning, attention to detail, and consideration of all perspectives, he has really come up with the best plan to bring our economy back. So the next time you’re ever having doubts and feeling like being a whiny baby--”The food’s too expensive!” “I can’t buy a house!” “I can’t find any jobs!” “My urgent heart surgery is taking years to get through the healthcare system!”--just remember that it’s now your responsibility to figure it out, courtesy of the one and only Justin Trudeau.`} />
                    </div>
                </div>
            </div>
        </div>
