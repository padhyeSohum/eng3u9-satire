            ...
            <div className="absolute w-2/3 right-0 top-0 h-full flex justify-center place-items-start py-24">
                <div className="flex flex-col w-3/5 place-items-center">
                    ...
                    <div>
                        ...
                        <Paragraph header={`Invite Trudeau to live with you and your 20 roommates!`} content={`You see, by creating initiatives to accordingly support this growing population, he would be taking valuable experience away from us--valuable experience that could be used to hone our survival skills. Newcomers may wonder, “Will there be enough housing to fit us comfortably?”`} />
